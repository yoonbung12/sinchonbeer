...
public interface OrderService {
	...
	List<OrderInfo> getOrderInfos(String memberId); // 유저 아이디로 주문정보 리스트를 받아옴
	List<OrderInfo> getOrderInfosByType(String type, String memberId); // 주문 카테고리와 유저 아이디로 주문정보 리스트를 받아옴
}
